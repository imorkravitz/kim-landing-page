...
export default function SEOHead({ 
  ...
  description = "ליווי תזונתי אישי לנשים בגישת 80:20 — תפריט מותאם, תמיכה יומית בווצאפ, אפליקציה תומכת וצוות דיאטניות קליניות בהובלת קים גפסון, בוגרת תואר בתזונה וסטודנטית לרפואה. הצטרפי ל-5,000+ מטופלות.",
